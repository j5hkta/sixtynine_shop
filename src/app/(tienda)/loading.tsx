...
export default function TiendaLoading() {
  return (
    <div
      role="status"
      aria-live="polite"
      className="flex min-h-[70vh] flex-col items-center justify-center gap-6 bg-ink px-4 text-center"
    >
      <span className="flex h-20 w-20 animate-pulse items-center justify-center bg-neon font-mono text-3xl font-black text-ink">
        69
      </span>

      <div className="space-y-3">
        <p className="text-sm font-bold tracking-[0.3em] text-neon uppercase">
          Cargando...
        </p>
      ...
      <span className="h-1 w-16 animate-pulse bg-neon/50" aria-hidden />
    </div>
  );
}
